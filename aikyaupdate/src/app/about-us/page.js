...
import Aboutusbannerhome from "@/assets/images/about-ushome.png"
...
export default function Aboutus() {
  ...
  <div className="block md:hidden w-full h-full">
    ...
    <div className="bg-gradient-to-br from-slate-50 to-purple-50 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
                {/* Values Section */}
                <div className="mb-20">

                     <h2 className="text-4xl md:text-4xl font-bold mb-4" style={{color: '#9a4481'}}>Values</h2>
          ...
          {values.map((value, index) => (
            ...
            >
              <div className="flex items-start space-x-4">
                <div className={`${value.bgColor} rounded-xl p-4 group-hover:scale-110 transition-transform duration-300`} style={{color: '#9a4481'}}>
                  {value.icon}
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-bold mb-3 tracking-wide" style={{color: '#9a4481'}}>
                    {value.title}
                  </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center relative">
                <div className="text-4xl md:text-4xl font-bold mb-3" style={{color: '#9a4481'}}>
                  {stat.number}
                </div>
        ...
        <div className="mb-4">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-16 h-1 rounded-full" style={{backgroundColor: '#9a4481'}}></div>
